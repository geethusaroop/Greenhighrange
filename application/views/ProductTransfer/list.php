...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo base_url(); ?>ProductTransfer/add"><i class="fa fa-dashboard"></i> Back To Add</a></li>
      <li class="active"></li>
    </ol>
              ...
              <div class="col-md-3">
                ...
                <div class="col-sm-4">
                    <div class="input-group">
                      ...
                      <a href="<?php echo base_url(); ?>ProductTransfer/add" class="btn btn-danger"><i class="fa fa-plus-square"></i> Add New</a>
                     &nbsp;<a href="<?php echo base_url(); ?>ProductTransfer"  <button type="button" class="btn btn-info">Refresh</button></a>
                    </div>
                </div>
            </div>
