                ...
                <div class="panel-body" style="font-weight:bold;background: #f5f5f5;">
                  <div class="form-group">
                    <div class="col-md-2">
                      ...
                      <input type="hidden" name="auto_invoice" id="purchase_auto_invoice_no" value="<?php if(isset($records[0]->auto_invoice)) echo $records[0]->auto_invoice;  ?>">
                      </div>
                      <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                          ...
                          <div class="form-group">
                            <div class="col-md-2" style="font-weight: bold;">
                              ...
                              <input type="hidden" id="vendor_name" value="<?php if(isset($records[0]->vendor_name)) echo $records[0]->vendor_name; ?>"/>
                              <select name="vendor_id" id="product_num1" style="width:180px;" class="form-control" onchange="gethsncode(this);" readonly="readonly">
                              ...
                              <div class="col-md-2">
                                ...
                                <div class="col-md-2">
                                  ...
                                  <table id="dataTable" class="table table-striped table-bordered tc-table footable" style="border:ridge;background: #5c5656;color:white;">
                                    ...
                                    <?php $i=1; foreach($records as $recod){ ?>
                                    <TR style="border:ridge;background: #b3b384;">
                                        <TD><INPUT type="checkbox" name="chk[]"/></TD>
                                        <TD> <?php echo $i ?> <input type="hidden" name="purchase_id[]" value="<?php if(isset($recod->purchase_id)) echo $recod->purchase_id ?>"></TD>
                                        <TD> <select name="product_id_fk[]" id="product_num<?php echo $i ?>" style="width:180px;" class="form-control" onchange="gethsncode(this);" readonly="readonly">
                                          <option value="" selected="selected">--SELECT--</option>
                                          <?php
                                          ...
                                          ?>          </select></TD>
                                           ...
                                           <TD> <INPUT type="text" class="form-control"  name="purchase_quantity[]" id="pquantity_<?php echo $i ?>" value="<?php if(isset($recod->purchase_quantity)) echo $recod->purchase_quantity ?>" style="width:80px;"/> </TD>
                                          ...
                                          <TD> <INPUT type="text" class="form-control" id="rate<?php echo $i ?>" value="<?php if(isset($recod->purchase_price)) echo $recod->purchase_price ?>" name="rate[]"  style="width:80px;"/> </TD>
                                          <TD> <INPUT type="text" class="form-control" id="mrp<?php echo $i ?>" value="<?php if(isset($recod->purchase_mrp)) echo $recod->purchase_mrp ?>" name="mrp[]"  style="width:80px;"/> </TD>
                                          <TD> <INPUT type="text" class="form-control" id="discount_<?php echo $i ?>" value="<?php if(isset($recod->discount_price)) echo $recod->discount_price ?>" name="discount_price[]"  style="width:80px;" onKeyUp="gettotalgrid(<?php echo $i; ?>,this)"/> </TD>
                                          <TD> <INPUT type="text" class="form-control" id="tamount<?php echo $i ?>"  value="<?php if(isset($recod->purchase_price)) echo $recod->purchase_quantity ?>" name="tamount[]"  style="width:80px;"/> </TD>
                                          <TD> <INPUT type="text" class="form-control" id="taxamount<?php echo $i ?>" value="<?php if(isset($recod->taxamount)) echo $recod->taxamount ?>" name="taxamount[]"/> </TD>
                                          <TD> <INPUT type="text" class="form-control" id="cgst<?php echo $i ?>" value="<?php if(isset($recod->purchase_cgst)) echo $recod->purchase_cgst ?>" name="cgst[]"  style="width:80px;"/> </TD>
                                          <TD> <INPUT type="text" class="form-control" id="cgstamt<?php echo $i ?>" value="<?php if(isset($recod->purchase_cgstamt)) echo $recod->purchase_cgstamt ?>" name="cgstamt[]"/> </TD>
                                          <TD> <INPUT type="text" class="form-control" id="sgst<?php echo $i ?>" value="<?php if(isset($recod->purchase_sgst)) echo $recod->purchase_sgst ?>" name="sgst[]"  style="width:80px;"/> </TD>
                                          <TD> <INPUT type="text" class="form-control" id="sgstamt<?php echo $i ?>" value="<?php if(isset($recod->purchase_sgstamt)) echo $recod->purchase_sgstamt ?>" name="sgstamt[]"/> </TD>
                                          <TD> <INPUT type="text" class="form-control" id="igst<?php echo $i ?>"  value="<?php if(isset($recod->purchase_igst)) echo $recod->purchase_igst ?>" name="igst[]"  style="width:80px;"/> </TD>
                                          <TD> <INPUT type="text" class="form-control" id="igstamt<?php echo $i ?>" value="<?php if(isset($recod->purchase_igstamt)) echo $recod->purchase_igstamt ?>" name="igstamt[]"/> </TD>
                                          <TD> <INPUT type="text" class="form-control" id="netamt<?php echo $i ?>"  value="<?php if(isset($recod->purchase_netamt)) echo $recod->purchase_netamt ?>" name="netamt[]"/> </TD>
                                        </TR>
                                        <?php $i++; } ?>
                                      </table>
                                      </div>
                                    ...
                                    <div class="panel-body" style="font-weight:bold;">
                                      ...
                                      <table style="width:30%" align="left" class="table table-bordered">
                                        <tr>
                                          <td>Gross Amount<input type='text' id='gross_amt' value="<?php if(isset($records[0]->purchase_netamt)) echo $records[0]->purchase_netamt ?>" class="form-control" name="gross_amt" /></td>
                                          <td>Taxable Amount<input type='text' id='taxamounts' value="<?php if(isset($records[0]->taxamount)) echo $records[0]->taxamount ?>" class="form-control" name="taxamounts" /></td>
                                          <td>Purchase Tax<input type='text' id='ptax' value="<?php if(isset($records[0]->taxamount)) echo $records[0]->taxamount ?>" name="ptax" class="form-control"/> </td>
                                        </tr>
                                        <tr style="width:30%" align="left" class="table table-bordered">
                                          <td>Purchase Amount<input type='text' id='pamount' value="<?php if(isset($records[0]->purchase_price)) echo $records[0]->purchase_price ?>" class="form-control" name="pamount"/></td>
                                          <td>Qty. Total<input type='text' id='qty_total' value="<?php if(isset($records[0]->purchase_netamt)) echo $records[0]->purchase_netamt ?>" class="form-control" name="qty_total" /></td>
                                          <td> Net Total<input type='text' id='net_total' value="<?php if(isset($records[0]->purchase_netamt)) echo $records[0]->purchase_netamt ?>" class="form-control" name="net_total" /></td>
                                        </tr>
                                        <tr style="width:30%" align="left" class="table table-bordered">
                                          <td >Old Balance<input type='text' id='old_bal_' value="<?php  echo (isset($records[0]->pur_old_bal)) ? $records[0]->pur_old_bal : 0 ?>" class="form-control" name="old_bal"/></td>
                                        </tr>
                                      </table>
                                      ...
                                      <div class="NetTotalAmount pull-right" style="font-size:18px;">
                                        <div class=" form-group pull-right" >
                                          ...
                                          <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo (isset($records[0]->purchase_netamt)) ? $records[0]->purchase_netamt : 0 ?>" name="total_amt" id="total_amt"  style="text-align: right;font-weight: bold;background: black;color:white;" />
                                          </div><br>
                                          <div class="col-md-12">
                                            <label>New Balance : &nbsp; </label>
                                            <input type="text" class="form-control" name="net_balance" id="net_balances" value="<?php echo (isset($records[0]->pur_new_bal)) ? $records[0]->pur_new_bal : 0 ?>" style="text-align: right;font-weight: bold;background: black;color:white;" />
                                          </div>
                                        </div>
                                      </div><!--first panel-->
                                    </div>
