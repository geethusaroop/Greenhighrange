    ...
    $(function() {
        ...
        $table = $('#purchase_details_table').DataTable({
            ...
            "createdRow": function(row, data, index) {
                ...
                $('td', row).eq(6).html('<center><a target ="_blank" class="btn btn-primary" href="<?php echo base_url(); ?>purchaseitem/invoice/' + data['auto_invoice'] + '">RETURN</a></center>');
                $('td', row).eq(7).html('<center><a target ="_blank"  href="<?php echo base_url(); ?>purchaseitem/invoice/' + data['auto_invoice'] + '"><i class="fa  fa-file iconFontSize-medium" ></i></a></center>');

                if (data['stockstatus'] == 0) {
                    $('td', row).eq(8).html('<center><input type="hidden" class="invno" value="' + data['auto_invoice'] + '"/><a onclick="masterStock(' + data['auto_invoice'] + ')"><i class="fa fa-check-square-o" ></i></a></center>');
                } else {
                    $('td', row).eq(8).html('<center><i class="fa fa-cubes" ></i></center>');
                }
                $('td', row).eq(9).html('<center><a href="<?php echo base_url(); ?>purchaseitem/view/' + data['auto_invoice'] + '"><i class="fa fa-eye" ></i></a></center>');
            },
            "columns": [{
...
<script type="text/javascript">
    ...
    function addRow(tableID) {
        ...
        element13.type = "text";
        element13.name = "cgstamt[]";
        element13.id = "cgstamt" + rowCount;
        ...
        element15.type = "text";
        element15.name = "sgstamt[]";
        element15.id = "sgstamt" + rowCount;
        ...
        element17.type = "text";
        element17.name = "igstamt[]";
        element17.id = "igstamt" + rowCount;
        ...
        element18.type = "text";
        element18.name = "netamt[]";
        element18.id = "netamt" + rowCount;
    ...
    function validate_return(data){
        var i = data.getAttribute('data-id');
        var retun_qty = data.value;
        var pur_qty = $('#pquantity_'+i).val(); 
        if(parseFloat(retun_qty) > parseFloat(pur_qty)){
            $('#returnquantity_'+i).val('');
            alert('Return quantity cannot greater than purchase quantity')
        }
    }
</script>