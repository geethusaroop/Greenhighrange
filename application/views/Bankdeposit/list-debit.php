  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url();?>Bankdeposit/add_credit"><i class="fa fa-dashboard"></i> Back To Add</a></li>
        <li class="active">  Debit Details</li>
      </ol>
    </section>
            ...
            <div class="row">
                  ...
                  <div class="col-sm-4">
                    <div class="input-group">
                      ...
                      <a href="<?php echo base_url();?>Bankdeposit/add_debit" class="btn btn-danger"><i class="fa fa-plus-square"></i>  Add new</a>
                    </div>
                  </div>
                </div>
