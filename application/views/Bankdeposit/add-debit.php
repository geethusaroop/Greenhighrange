<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
	...
	<!-- Main content -->
    <form class="form-horizontal" method="POST" action="<?php echo base_url();?>Bankdeposit/add_debit">
     <!-- Main content -->
          ...
          <div class="box">
              ...
              <!-- radio -->
			   ...
			   <input type="hidden" name="bd_id" value="<?php if(isset($records->bd_id)) echo $records->bd_id ?>"/>
				...
				<div class="panel-heading">
					<h3 class="panel-title"><b>NEW DEBIT DETAILS</b></h3>
				</div>
				...
				<div class="form-group">
					...
					<select name="bd_member_id_fk" id="bd_member_id_fk" class="form-control">
						...
						<?php foreach($vendor_names as $row){ ?>
							<option <?php if(isset($records->bd_member_id_fk)){if($records->bd_member_id_fk==$row->vendor_id){echo "selected";}} ?> value="<?php echo $row->vendor_id; ?>"><?php echo $row->vendorname; ?></option>
						<?php } ?>
					</select>					
				</div>
			...
			<div class="box-footer">                
                <div class="row">
                  ...
                  <div class="col-md-4">
                      <a href="<?php echo base_url(); ?>Bankdeposit/debit"><button type="button" class="btn btn-danger">Cancel</button></a>
