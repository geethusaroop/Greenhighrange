  ...
  $(function () {
    ...
    $table = $('#receipt_list').DataTable( {
        ...
        "createdRow": function ( row, data, index ) {
			...
			$('td', row).eq(6).html('<center><a href="<?php echo base_url();?>Bankdeposit/edit_debit/'+data['bd_id']+'"><i class="fa fa-edit iconFontSize-medium" ></i></a>&nbsp;&nbsp;&nbsp;<a onclick="return confirmDelete('+data['bd_id']+')"><i class="fa fa-trash-o iconFontSize-medium" ></i></a></center>');
        },
