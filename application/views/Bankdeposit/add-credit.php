<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
	...
	<!-- Main content -->
    <form class="form-horizontal" method="POST" action="<?php echo base_url();?>Bankdeposit/add_credit">
     <!-- Main content -->
          ...
          <div class="box">
			...
			<div class="box-footer">                
                <div class="row">
                  ...
                  <div class="col-md-4">
                      <a href="<?php echo base_url(); ?>Bankdeposit/credit"><button type="button" class="btn btn-danger">Cancel</button></a>
