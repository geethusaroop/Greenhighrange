<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
	...
	<!-- Main content -->
    <form class="form-horizontal" method="POST" action="<?php echo base_url();?>Bankdeposit/add">
     <!-- Main content -->
          ...
          <div class="box">
              ...
              <!-- radio -->
			   ...
			   <input type="hidden" name="bd_id" value="<?php if(isset($records->bd_id)) echo $records->bd_id ?>"/>
				...
				<div class="panel-heading">
					<h3 class="panel-title"><b>NEW BANK DEPOSIT DETAILS</b></h3>
				</div>
			...
			<div class="box-footer">                
                <div class="row">
                  ...
                  <div class="col-md-4">
                      <a href="<?php echo base_url(); ?>Bankdeposit/"><button type="button" class="btn btn-danger">Cancel</button></a>
