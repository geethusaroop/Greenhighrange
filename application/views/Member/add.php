                ...
                <div class="panel-body" style="font-weight:bold;">
                 <!--  <div class="col-md-6">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-4">
                      <label class="fsize">GST <span style="color: red;"> *</span></label>
                      <input type="text" autofocus class="form-control" name="member_gst" value="<?php if (isset($records->member_gst)) echo $records->member_gst ?>">
                    </div>
