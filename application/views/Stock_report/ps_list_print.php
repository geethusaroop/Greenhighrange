                                ...
                                <div class="col-md-3">
                                    <div class="input-group margin">
                                        ...
                                        <select name="product_id" class="form-control select" id="pbar1">
                                            <option value="">SELECT</option>
                                            <?php foreach ($product as $product_list) { ?>
                                                <option <?php if (isset($product_id)) {
                                                            if ($product_name == $product_list->product_id) {
                                                                echo "selected";
                                                            }
                                                        } ?> value="<?php echo $product_list->product_id ?>"><?php echo $product_list->product_barcode; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
