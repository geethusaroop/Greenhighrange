 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Master To Branch Sale Details

        <!-- <small>Optional description</small> -->
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url();?>Dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo base_url();?>MBTSale/add"><i class="fa fa-dashboard"></i> Back to Add</a></li>
        <li class="active"> Master To Branch Sale Details</li>
      </ol>
    </section>
    ...
    <section class="content">
			...
			<div class="col-sm-1">
			  ...
			  <!--<div class="col-md-2">
                  <a href="<?php echo base_url();?>index.php/mbtsale/" class="btn btn-success"><i class="glyphicon glyphicon-user"></i>Sale List</a>
              </div>-->
            <div class="col-md-1">
				<div class="input-group margin">
					<a href="<?php echo base_url();?>MBTSale/add" class="btn btn-primary"><i class="fa fa-plus-square"></i>  Add Sale</a>
				</div>
			</div>
            </div>
