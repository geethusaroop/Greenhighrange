...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      MASTER TO BRANCH SALE
      <small id="date" class="col-md-4"></small>
      <!-- <small>Optional description</small> -->
    </h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url(); ?>dashboard/"><i class="fa fa-dashboard"></i> Home</a></li>
      <li><a href="<?php echo base_url(); ?>MBTSale/"><i class="fa fa-dashboard"></i> Back to List</a></li>
      <li class="active">Sales Form</li>
    </ol>
  </section>
  <!-- Main content -->
  <form class="form-horizontal" method="POST" action="<?php echo base_url(); ?>MBTSale/add">
              ...
              <div class="panel panel-info" style="box-shadow: 4px 3px 4px 3px #172158;">
                ...
                <div style="box-shadow: 4px 3px 4px 3px #97989b;">
                  ...
                  <div class="form-group" style="margin-left: 20px;">
                    ...
                    <select name="branch_name" class="form-control select2" id="branch_name" style="width:300px;">
                    <option value="">-SELECT-</option>
                ...
                <div class="table-responsive">
                  ...
                  <thead style="background: black;color: white;text-transform: uppercase;">
                    ...
                    <TD> <INPUT type="text" class="form-control" id="discount_1" name="discount_price[]"  style="width:80px;" onKeyUp="gettotalgrid(<?php echo $i=1; ?>,this)"/> </TD>
                        ...
                        <TD><INPUT type="hidden" class="form-control" id="hsncode_id1" name="hsncode_id[]" style="width: 30px;" /> </TD>
                        <TD><INPUT type="hidden" class="form-control" id="product_unit1" name="product_unit[]" style="width: 30px;" /> </TD>
                        <TD><INPUT type="hidden" class="form-control" id="product_category1" name="product_category[]" style="width: 30px;" /> </TD>
                        <TD><INPUT type="hidden" class="form-control" id="product_unit_type1" name="product_unit_type[]" style="width: 30px;" /> </TD>
                      </TR>
                  </table>
                  </div>
