      ...
      <div class="row">
        <div class="box">
            ...
            <input type="hidden" id="response" value="<?php echo $this->session->flashdata('response');?>" />
              ...
              <center>       
  <form name="" method="post" action="<?php echo base_url(); ?>BBalancesheet/get">
  <div class="row">
  ...
  <?php if(isset($sdate)){if(isset($edate)){ ?>
       ...
       <div class="col-lg-6">
              <table class="table table-bordered" style="border-color:#d4d6d5;">
                <thead>
                  <tr>
                    <th colspan="5"><b style="color:#0f0f0f;font-weight: bold;font-size: 17px;"><center><i><?php echo strtoupper("GREENHIGHRANGE FARMERS PRODUCER COMPANY LIMITED"); ?></i></center></b></th>
                  </tr>
                   <tr>
                   <tr>
