...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
    Stock Return From Branch To Master
      <small id="date" class="col-md-4"></small>
      <!-- <small>Optional description</small> -->
    </h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url(); ?>Dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
      <li><a href="<?php echo base_url(); ?>BProduct/add_return"><i class="fa fa-dashboard"></i> Back To Add</a></li>
      <li class="active"></li>
    </ol>
    <div class="row">
      <div class="col-md-3">
      ...
      <div class="box">
        <div class="box-header">
          ...
          <div class="col-md-2">
            ...
            <a href="<?php echo base_url(); ?>BProduct/add_return" class="btn btn-danger"><i class="fa fa-plus-square"></i> Add New</a>
          </div>
