...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo base_url();?>BLedger/add"><i class="fa fa-dashboard"></i> Back to Add</a></li>
  ...
  <section class="content">
    <div class="row">
      <div class="box">
            <form name="" method="post" action="<?php echo base_url(); ?>BLedger/getledger_report">
