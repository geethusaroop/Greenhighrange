        ...
        <div class="row">
            <div class="box">
                ...
                <div class="box-header">
                    ...
                    <form name="" method="post" action="<?php echo base_url(); ?>Saleregister/getPurchaseReports">
                        <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <button type="submit" id="search" class="btn bg-orange btn-flat margin" onclick="<?php if (isset($values->mainhead_id)) echo $values->mainhead_id; ?>">Search</button>
                                         <a href="<?php echo base_url(); ?>Saleregister/"><button class="btn bg-navy btn-flat margin">Refresh</button></a>
                        ...
                        <div class="col-md-8">
                            <table class="table table-bordered table-hover" id="dataTable1" style="border:1px solid #0a0a0b;">
                                ...
                                <tr>
                                    ...
                                    <th style="border:1px solid #0a0a0b;">GSTNO</th>
                                    <th style="border:1px solid #0a0a0b;">INVNO</th>
                                        <th style="border:1px solid #0a0a0b;">AMT</th>
                                        <th style="border:1px solid #0a0a0b;text-align:right;">CGST</th>
                                        <th style="border:1px solid #0a0a0b;text-align:right;">SGST</th>
                                        <th style="border:1px solid #0a0a0b;text-align:right;">AMT</th>
                                        <th style="border:1px solid #0a0a0b;text-align:right;">DISCOUNT</th>
                                        <th style="border:1px solid #0a0a0b;text-align:right;">NETAMT</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php $i = 1;
                                    ...
                                    foreach ($records as $row) { ?>
                                        <tr style="border:1px solid #0a0a0b;">
                                            <td style="border:1px solid #0a0a0b;"><?php echo date('d/m/Y',strtotime($row->sale_date)); ?></td>
                                            <td style="border:1px solid #0a0a0b;"><?php echo $row->member_name; ?></td>
                                            <td style="border:1px solid #0a0a0b;"><?php echo $row->member_gst; ?></td>
                                            ...
                                            <td style="border:1px solid #0a0a0b;text-align:right;"><?php echo $row->cgst; ?></td>
                                            <td style="border:1px solid #0a0a0b;text-align:right;"><?php echo $row->sgst; ?></td>
                                            <td style="border:1px solid #0a0a0b;text-align:right;"><?php echo ($row->total)+($row->cgst)+($row->cgst); ?></td>
                                            <td style="border:1px solid #0a0a0b;text-align:right;"><?php echo ($row->sale_discount); ?></td>
                                            <td style="border:1px solid #0a0a0b;text-align:right;"><?php echo (($row->total)+($row->cgst)+($row->cgst))-($row->sale_discount);; ?></td>
                                        </tr>
                                    <?php $i++;
                                      //  $tasx = $tasx + $row->tax;
                                      //  $tot = $tot + $row->total;
