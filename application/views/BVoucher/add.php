  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
		...
		<li><a href="<?php echo base_url();?>BVoucher"><i class="fa fa-dashboard"></i> Back To list</a></li>
	  </ol>
    </section>
	<!-- Main content -->
    <form class="form-horizontal" method="POST" action="<?php echo base_url();?>BVoucher/add" >
     <!-- Main content -->
            ...
            <div class="col-lg-10">
              <div class="panel panel-danger" style="box-shadow:2px 2px 2px 2px black;">
                <div class="panel-heading">
                  <h3 class="panel-title"><b>Voucher Details</b></h3>
                </div>
			  ...
			  <div class="box-footer">                
                <div class="row">
                  ...
                  <div class="col-md-4">
				  <a href="<?php echo base_url();?>BVoucher">  <button type="button" class="btn btn-danger">Cancel</button></a>
