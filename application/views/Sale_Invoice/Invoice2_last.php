        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">
                    <center>SALE INVOICE POS</center>
                </h4>
            </div>
            <div class="modal-body">
                <div id="pos_reciepts">
                    <div style="width: 300px; margin: 0 auto; border: 1px solid #f2f2f2;box-shadow: 0 0 1in -0.25in rgba(0, 0, 0, 0.5); padding: 15px;">
                        ...
                        <h6 style="text-align: center; font-size: 15px; margin: 5px 0px;font-size: 12px;">NO, 106/14,VAKACHUVADU, PRABHACITY,<br />KANJIKUZHY, IDUKKI PO, KERALA - 685606</h6>
                        <h6 style="text-align: center; font-size: 17px; margin:10px 0px;font-size: 12px;">Tel: +91 7907753352, +91 9633379372 </h6>
                        <h6 style="text-align: center; font-size: 17px; margin:10px 0px;font-size: 12px;">GSTIN:32BWUPG1355F1ZM<br>CIN:U01100KL2021PTC071331</h6>
                        <table class="pos_rec">
                            <tr>
                                <th style="width: 50px;text-align: center "><b>Tax Invoice</b></th>
                            </tr>
                        </table>
                        <table style="text-align: center">
                            <tbody>
                                <tr>
                                    <td style="width: 50px;font-size: 12px;">Name</td>
                                    <td style="width: 120px;font-size: 12px;"></td>
                                </tr>
                                <tr>
                                    <td style="width: 50px;font-size: 12px;">Address</td>
                                    <td style="width: 120px;font-size: 12px;"></td>
                                </tr>
                                <tr>
                                    <td style="width: 50px;font-size: 12px;">GSTIN</td>
                                    <td style="width: 120px;font-size: 12px;"></td>
                                </tr>
                                <tr>
                                    <td style="width: 50px; text-align: center;font-size: 12px;" colspan="2">State Kerala Code: 32</td>
                                </tr>
                                <tr>
                                    <td style="width: 50px; text-align: center;font-size: 12px;">Invoice No:</td>
                                    <td style="width: 120px; text-align: center;font-size: 12px;"><?php echo $records[0]->invoice_number; ?></td>
                                </tr>
                                <tr>
                                    <td style="width: 50px; text-align: center;font-size: 12px;">Invoice Date:</td>
                                    <td style="width: 120px; text-align: center;font-size: 12px;"><?php if (isset($records[0]->sale_date)) {
                                                                                                        $pr_date = str_replace('-', '/', $records[0]->sale_date);
                                                                                                        $pr_date =  date("d/m/Y", strtotime($pr_date));
                                                                                                        echo $pr_date;
                                                                                                    } ?></td>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="width: 120px"><?php echo $rec->product_name; ?></td>
                                        <td style="width: 50px"><?php echo $rec->sale_price; ?></td>
                                        <td style="width: 120px"><?php $qty += $rec->sale_quantity;
                                                                    echo $rec->sale_quantity; ?></td>
                                        <td style="width: 120px"><?php $tot += $rec->total_price;
                                                                    echo $rec->total_price; ?></td>
                                    </tr>
                                    <tr>
                                        <td colspan="3">
                                            <center>Total</center>
                                ...
                                <?php } ?>
                                <tr>
                                    <td style="width: 50px;font-size:9px;">CGST:</td>
                                    <td style="width: 120px">0.00</td>
                                    <td style="width: 120px;font-size:9px;" colspan="2">Discount:</td>
                                    <td style="width: 120px">0.00</td>
                                </tr>
                                <tr>
                                    <td style="width: 50px;font-size:9px;">SGST:</td>
                                    <td style="width: 120px">0.00</td>
                                    <td style="width: 120px;font-size:9px;" colspan="2">Roundoff:</td>
                                    <td style="width: 120px">0.00</td>
                                </tr>
                                <tr>
                                    <td style="width: 120px;font-size:8px;" colspan="4"></td>
                                    <td style="width: 50px;" colspan=""><?php echo $records[0]->sale_netamt; ?></td>
                                </tr>
                                <tr>
                                    <td style="width: 120px;font-size:10px;" colspan="4">Account No: 346701010170098<br>
                                    IFSC: UBIN0534676<br>
                                    Greenhighrange farmers Producer CO LTD<br>
                                    Union Bank,Idukki
                                </td>
                                    <td style="width: 50px;" colspan="">E&OE</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
