                    ...
                    <div id="divName">
                        <div class="col-md-12">
                            ...
                            <thead style="box-shadow: 0px 2px 10px 0px rgb(53 44 44 / 75%);border:1px solid #dee2e6;">
                                    ...
                                    <th style="border:1px solid #dee2e6;">BRANCH</th>
                                    ...
                                    foreach ($records as $row) {
                                      ...
                                      ?>
                                        <tr>
                                            ...
                                            <td style="border:1px solid #dee2e6;"><?php echo $row->branch_name; ?></td>
                                            ...
                                            <td style="border:1px solid #dee2e6;"><?php echo $row->bt_stock; ?></td>
                                            <td style="border:1px solid #dee2e6;"><?php echo $row->bt_date; ?></td>
                                        </tr>
                                    <?php $i++;
                                        $qty = $qty + $row->bt_stock;
                                    } ?>
