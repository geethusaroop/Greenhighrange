...
$(document).on('change','#receipt_name',function(){
	...
	{
		$.ajax({
            url:"<?php echo base_url();?>BReceipt/get_receipthead",
  ...
  $(function () {
    ...
    $table = $('#receipt_list').DataTable( {
        ...
        "bDestroy" : true,
        "ajax": {
            "url": "<?php echo base_url();?>BReceipt/get",
            "type": "POST",
            "data" : function (d) {
       ...
       $('td', row).eq(7).html('<center><a href="<?php echo base_url();?>BReceipt/treceipt/'+data['receipt_id']+'"><i class="fa fa-file iconFontSize-medium" ></i></a></center>');
       
			$('td', row).eq(8).html('<center><a href="<?php echo base_url();?>BReceipt/edit/'+data['receipt_id']+'"><i class="fa fa-edit iconFontSize-medium" ></i></a>&nbsp;&nbsp;&nbsp;<a onclick="return confirmDelete('+data['receipt_id']+')"><i class="fa fa-trash-o iconFontSize-medium" ></i></a></center>');
        },
        "columns": [
 ...
 function confirmDelete(receipt_id){
    ...
    if(conf){
        $.ajax({
            url:"<?php echo base_url();?>BReceipt/delete",
            data:{receipt_id:receipt_id},
            method:"POST",
            datatype:"json",
            success:function(data){
