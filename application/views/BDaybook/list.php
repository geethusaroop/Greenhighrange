...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo base_url(); ?>BDaybook"><i class="fa fa-dashboard"></i> Back to List</a></li>
  ...
  <section class="content">
    <div class="row">
      <form name="" method="post" action="<?php echo base_url(); ?>BDaybook/getdaybook">
        <div class="box">
        ...
        <div class="col-lg-10">
          <table class="table table-bordered table-striped" style="border-color:#d4d6d5;">
            ...
            <?php foreach ($mbtsaleincome as $rows) {if($rows->total_amount!=0){ ?>
                <tr>
                  <td style="border-color:#d4d6d5;"><?php echo "Stock Purchase From Master Branch"; ?></td>
                 <td style="border-color:#d4d6d5;"><?php echo $rows->invoice_number; ?></td>
                  <td style="border-color:#d4d6d5;"></td>
                  <td style="border-color:#d4d6d5;"><?php if(!empty($rows->total_amount)) { echo $rows->total_amount; } else { echo 0; } ?></td>
                </tr>
            ...
            <tfoot>
              ...
              $debit = $tvoucher + $obalance1 + $purchase + $feedpurchase + $sal + $adv+$vvoucher+$mbtsale;
              //$credit_sum=
