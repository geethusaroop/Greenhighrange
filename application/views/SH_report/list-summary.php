...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="row">
      <div class="box">
        <form name="" method="post" action="<?php echo base_url(); ?>SH_report/getsummary_report">
              ...
              <table class="table table-bordered table-striped" style="border-color:#d4d6d5;" width="100%">
                <thead>
                  ...
                  <tr>
                    ...
                    <th style="border-color:#d4d6d5;text-align: center;">NET_TOTAL</th>
                    <th style="border-color:#d4d6d5;text-align: center;">PAID_AMOUNT</th>
                    <th style="border-color:#d4d6d5;text-align: center;">NEW_BALANCE</th>
                ...
                <tbody>
                  ...
                  $total3 = 0;
                  ?>
                  <?php foreach ($member_names as $row) {foreach ($sale as $sh_report) {if($sh_report->member_id_fk==$row->member_id){ ?>
                    <tr>
                   
                      <td style="border-color:#d4d6d5;text-align: left;"><?php echo $row->member_name; ?></td>
