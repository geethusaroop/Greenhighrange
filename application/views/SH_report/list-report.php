              ...
              <table class="table table-bordered table-striped" style="border-color:#d4d6d5;" width="100%">
                <thead>
                  ...
                  <tr>
                    ...
                    <th style="border-color:#d4d6d5;">PRODUCTS</th>
                ...
                <tbody>
                  ...
                  <?php foreach ($sale as $sh_report) { ?>
                    <tr>
                      ...
                      <td style="border-color:#d4d6d5;"><?php echo $sh_report->product_name; ?></td>
                      <td style="border-color:#d4d6d5;text-align: center;"><?php echo number_format($sh_report->total_price, 2); ?></td>
