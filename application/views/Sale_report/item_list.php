 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Item Sale Report</li>
      </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
			  ...
			  <div class="col-md-12">
        <form name="" method="post" action="<?php echo base_url(); ?>Sale_Report/itemSaleRport1">
			...
			<div class="col-md-4">
			   <div class="input-group margin">
                    ...
                    <select name="item_id" class="form-control select2" id="item_id">
                        ...
                        <option <?php if(isset($item_id)){if($item_id==$item_list->product_name){echo "selected";}} ?> value="<?php echo $item_list->product_name ?>"><?php echo $item_list->product_name ?></option>
                        <?php } ?>
                    </select>
				</div><!-- /input-group -->
			</div>
      ...
      <div class="col-md-3">
                                    <div class="input-group">
                                        <button type="submit" id="search" class="btn bg-orange btn-flat margin" onclick="<?php if (isset($values->mainhead_id)) echo $values->mainhead_id; ?>">Search</button>
                                         <a href="<?php echo base_url(); ?>Sale_Report/itemSaleRport"><button class="btn bg-navy btn-flat margin">Refresh</button></a>
