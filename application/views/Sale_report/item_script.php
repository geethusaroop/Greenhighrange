...
var response = $("#response").val();
 ...
 //var total= $( api.column(5).footer() ).html(json.records_total[0].tqty);
          ...
          pageTotal = api
                  ...
                  $(api.column(6).footer()).html('<center><i class="fa fa-inr"></i>' + pageTotal + ' (' + json.records_total[0].price + ')</center>')
                  ...
                  $(api.column(7).footer()).html('<center>'+' ' + pageTotal3 + ' (' + parseFloat(json.records_total[0].qty).toFixed(2) + ')</center>')
                  ...
                  $(api.column(8).footer()).html('<center><i class="fa fa-inr"></i>'+' ' + pageTotal4 + ' (' + parseFloat(json.records_total[0].snet).toFixed(2) + ')</center>')
      ...
      "ajax": {
        "url": "<?php echo base_url(); ?>Sale_Report/getitemSaleRport/",
        "type": "POST",
        "data": function(d) {
