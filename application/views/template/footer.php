  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php echo date("Y"); ?> <a href="#">Wahylab Solutions</a>.</strong> All rights reserved.
...
<!-- Optionally, you can add Slimscroll and FastClick plugins.
    ...
    <script src="<?php echo base_url();?>assets/fullcalendar/dist/index.global.js" type="text/javascript"></script>
    ...
    <script src="<?php echo base_url();?>assets/Excel/tableExport/tableExport.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>assets/Excel/tableExport/jquery.base64.js"></script>
</body>
