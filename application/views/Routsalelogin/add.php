...
<div class="content-wrapper" style="background-color: #eef1f5;">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo base_url(); ?>Routsalelogin"><i class="fa fa-dashboard"></i> Back to List</a></li>

      <li class="active"> Rout Sale Login</li>
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-info container">
          ...
          <form class="form-horizontal" method="POST" action="<?php echo base_url(); ?>Routsalelogin/add" enctype="multipart/form-data">
