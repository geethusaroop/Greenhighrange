<script>
  ...
  $(function () {
    ...
    $table = $('#employee_table').DataTable( {
        ...
        "ajax": {
            ...
            "url": "<?php echo base_url();?>Routsalelogin/get",
      ...
      $('td', row).eq(2).css('font-weight','bold');
			...
			$('td', row).eq(3).html('<center><a href="<?php echo base_url();?>Routsalelogin/edit/'+data['id']+'"><i class="fa fa-edit iconFontSize-medium" ></i></a>&nbsp;&nbsp;&nbsp;<a onclick="return confirmDelete('+data['id']+')"><i class="fa fa-trash-o iconFontSize-medium" ></i></a></center>');
  ...
  function confirmDelete(id){
    ...
    var conf = confirm("Do you want to Delete ?");
        ...
        $.ajax({
            ...
            url:"<?php echo base_url();?>Routsalelogin/delete/",
...

  {
    ...
    $.ajax({
            ...
            url:"<?php echo base_url()?>Routsalelogin/getdes",
