...
function addMore() {
	...
	$.ajax({
			...
			url: "<?php echo base_url()?>RSSale/getproductname",
            type: 'POST',
            ...
            //     {
            //         $.ajax({
            //               url: "<?php echo base_url();?>RSSale/getprice",
    ...
    $.ajax({
            type: "POST",
            url: "<?php echo base_url()?>RSSale/gettax",
...
$(document).on("change",'.product_num',function(){
   ...
   // alert(p_id);
    ...
    if(p_id)    
     {
         $.ajax({
             url:"<?php echo base_url();?>RSSale/get_price",
            data:{p_id:p_id},
            type:'POST',
            dataType:"json",
            success:function(data){
    ...
    if(taxtype)
        {
            ...
            function(data)
            {
                ...
                $.ajax({
                    url: "<?php echo base_url()?>RSSale/getproductname1",
                    data:{p_id:prodd},
                    type: 'POST',
                    success: function(data)
                    {
...
$(document).on("change",'.price',function(){
	...
	$(document).on("change",'.product_num',function(){
		...
		if(product_num){
			$.ajax({
            url:"<?php echo base_url();?>rssale/get_purchasedetails",
            type: 'POST',
...
$(document).on("change",'.product_num',function(){
	...
	if(product_id){
		$.ajax({
		url:"<?php echo base_url();?>RSSale/getstock",
		type: 'POST',
  ...
  $(function () {
    ...
    $table = $('#sale_details_table').DataTable( {
        ...
        "createdRow": function ( row, data, index ) {
			...
			$('td', row).eq(6).html('<center><a target ="_blank"  href="<?php echo base_url();?>RSSale/invoiceview/'+data['invoice_number']+'"><i class="fa  fa-file iconFontSize-medium" ></i></a></center>');
            },
        "columns": [
...
//   {
//    $.ajax({
//     url:"<?php echo site_url('RSSale/get_memberaddress');?>",
//     method:"POST",
...
$(document).on("change",'#customer_nam',function(){
        ...
        if(id){
            $.ajax({
            url:"<?php echo base_url();?>RSSale/get_memberaddress",
            type: 'POST',
            data:{id:id},
            dataType: 'json',
            success:function(data){
            ...
            $.ajax({
                url:"<?php echo base_url();?>RSSale/get_phone",
                type: 'POST',
                data:{id:id},
                dataType: 'json',
                success:function(data){
...
<script type="text/javascript">
   ...
   // element18.setAttribute("class", "democlass");
      //  element17.required = "required";
        ...
        var options = {
        // url: "<?php echo base_url() ?>RSSale/getproduct_names",
        url: function(phrase) {
            return "<?php echo base_url() ?>RSSale/getproduct_names?phrase=" + phrase + "&format=json";
        },
        getValue: "name",
        list: {
            match: {
    ...
    { 
                  $.ajax({
                      type: 'POST',
                      url: '<?php echo base_url() . 'index.php/RSSale/getProductDetails1'; ?>',
                      data: {
    ...
    { //alert($("#product_num"+row).val());
                  $.ajax({
                      type: 'POST',
                      url: '<?php echo base_url() . 'index.php/RSSale/getProductDetails2'; ?>',
                      data: {
...
function getcustomer()
    ...
    $('#member_types_all').on('change',function(){
      $('#custname').empty();
        ...
        //alert(mem_id);
        $.ajax({
                url:"<?php echo base_url();?>RSSale/getMemberList",
                type: 'POST',
                data:{mem_id:mem_id},
                dataType: 'json',
    ...
    $('#custname').on('change',function(){
        var mem_id = this.value;
        $.ajax({
                url: "<?php echo base_url(); ?>RSSale/get_old_bal",
                type: 'POST',
                data: {
                    vid: mem_id
                },
