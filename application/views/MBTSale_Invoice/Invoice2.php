    ...
    <div class="inner" id="invcontent">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <br><br>
          Buyer Details: <strong><?php echo strtoupper(@$records[0]->branch_name);?></strong>,
           <?php echo @$records[0]->branch_address;?>,
           Phone: <?php echo @$records[0]->branch_phn;?>
          , Email: <?php echo @$records[0]->branch_email;?>
      </div>
    </div>
    <br>
      <!-- /.row -->
