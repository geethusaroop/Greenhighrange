  ...
  $(function () {
    ...
    $table = $('#Vendor_table').DataTable( {
        ...
        "createdRow": function ( row, data, index ) {
			...
			$('td', row).eq(8).html('<center><a href="<?php echo base_url();?>Vendor_master/edit/'+data['vendor_id']+'"><i class="fa fa-edit iconFontSize-medium" ></i></a>&nbsp;&nbsp;&nbsp;<a onclick="return confirmDelete('+data['vendor_id']+')"><i class="fa fa-trash-o iconFontSize-medium" ></i></a></center>');
