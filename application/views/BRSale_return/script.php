<script>
    ...
    $(function() {
        ...
        $table = $('#purchase_details_table').DataTable({
            ...
            "createdRow": function(row, data, index) {
                ...
                $('td', row).eq(6).html('<center><a href="<?php echo base_url(); ?>BRSale/editedSaleRet/' + data['auto_invoice'] + '"><i class="fa fa-edit iconFontSize-medium" ></i></a></center>');
            },
    ...
    function confirmDelete(m_pur_invo) {
        alert('yes');
        var conf = confirm("Do you want to Delete All Item from This Sale ?");
        if (conf) {
            $.ajax({
...
<script type="text/javascript">
    ...
    function gettotal(bal) { //alert("hai");
