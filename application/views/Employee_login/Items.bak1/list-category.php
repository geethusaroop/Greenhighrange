 ...
 -->                  </tr>
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-header">
        <h4 class="modal-title"><b> Products Category</b></h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form class="form-horizontal" method="POST" action="<?php echo base_url();?>index.php/Items/addcategory" enctype="multipart/form-data">
      ...
      <div class="form-group">
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="text" data-pms-required="true" autofocus class="form-control" name="cat_name" id="cat_name" value="" style="text-transform: uppercase;">
                      </div>
                      </div>
