...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 class="row">Products - Sofas & Furnitures
        <!-- Company Management -->
      </h1>
      <ol class="breadcrumb">
 ...
 -->                </div>
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-header">
        <h4 class="modal-title"><b> Products-Sofas & Furnitures</b></h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form class="form-horizontal" method="POST" action="<?php echo base_url();?>index.php/Items/addItem4" enctype="multipart/form-data">
