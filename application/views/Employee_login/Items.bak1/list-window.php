...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 class="row">Products - Window Blinds
        <!-- Company Management -->
      </h1>
      <ol class="breadcrumb">
 ...
 -->                </div>
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-header">
        <h4 class="modal-title"><b> Products-Window Blinds</b></h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form class="form-horizontal" method="POST" action="<?php echo base_url();?>index.php/Items/addItem2" enctype="multipart/form-data">
      ...
      <div class="form-group">
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <span style="color:red">* Only Applicable To Roman Blinds </span>
                        <div class="form-group">
                      <!--   <div class="col-md-4">
                        <label>Fabric Type <span style="color:red">*</span></label>
                        <select class="form-control" name="product_material" id="product_material">
                              <option value="">Select</option>
                              <option value="1">Curtain Fabric</option>
                              <option value="2">Blind Set</option>
                          </select>  
                      </div> -->

                      <div class="col-md-4">
                            <label>Curtain<span style="color:red">*</span></label>
                           
                            <select class="form-control" name="product_material" id="product_material">
                              <option value="">Select</option>
                              <?php
                              foreach ($curtain as $row) {
                              ?>
                        ...
                        <div class="col-md-2">
                          ...
                          <input type="text"  autofocus class="form-control" name="product_meter_price"  id="product_meter_price" value="" style="font-weight: bold; text-transform: uppercase;background: white;">
                        </div>
