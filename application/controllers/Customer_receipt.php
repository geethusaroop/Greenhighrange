...
class Customer_receipt extends MY_Controller {
	public $table = 'tbl_customer_receipt';
	public $page  = 'Customer_receipt';
	public function __construct() {
		...
		$this->load->model('Customer_receipt_model');
		$this->load->model('Bankdeposit_model');
	}
	public function index()
	{
		$template['body'] = 'Customer_receipt/list';
		$template['script'] = 'Customer_receipt/script';
	...
	public function add(){
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$template['body'] = 'Customer_receipt/add';
			$template['script'] = 'Customer_receipt/script';
			 $prid =$this->session->userdata('prid');
			 $admno = $this->Customer_receipt_model->get_admno($branch_id_fk);
	...
	public function get(){
		...
		$data = $this->Customer_receipt_model->getSupplierTable($param,$branch_id_fk);
	...
	public function receipt($receipt_id){
		$template['body'] = 'Customer_receipt/receipt';
		$template['script'] = 'Customer_receipt/script-receipt';
